...
def initialize_model(vocab_path, model_name="facebook/wav2vec2-base"):
    ...
    model = Wav2Vec2ForCTC.from_pretrained(
        ...
        mask_time_prob=0.3,      # SpecAugment trục thời gian
        mask_feature_prob=0.1,    # SpecAugment trục tần số (che 10% kênh tần số)
        mask_feature_length=25,   # Chiều dài mỗi vùng che trên trục tần số
